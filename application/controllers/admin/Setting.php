...
class Setting extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $email_order                   = $this->setting_model->email_order();
        // $payment                        = $this->pembayaran_model->get_pembayaran();
        $sendemail                      = $this->sendemail_model->get_sendemail();
    ...
    {
        $pengaturan = $this->setting_model->detail_setting($id);
    ...
    {
        $sendemail = $this->sendemail_model->sendemail_status_all();
        $data = [
            'title'     => 'Kirim Email',
            'sendemail'  => $sendemail,
            'content'   => 'admin/pengaturan/index_pengaturan'
    ...
    public function sendemail_inactive($id)
    {
        ...
        $this->sendemail_model->update($data);
