...
<footer class="bg-dark mt-auto text-muted">
    ...
    <div class="container pt-4 pt-md-5 pb-md-5">
        <div class="row">
            ...
            <div class="col-6 col-md-2">
                ...
                <ul class="list-unstyled text-small">
                    ...
                    <li> <a class="text-muted" href="<?php echo base_url('') ?>">Cek Order</a></li>
                </ul>
            </div>
    ...
    <div class="credit py-3 bg-dark border-top border-secondary">
        <div class="container">
            <div class="credit bg-dark text-muted py-md-3">Copyright &copy; <?php echo date('Y') ?> - <?php echo $meta->title ?> - <?php echo $meta->tagline ?></div>
        </div>
    </div>
</footer>
